...
test("Renders Task and Subtask correctly", () => {
    ...
    const{container} = render(<BrowserRouter><Task expanded checked name = "Test 1" subtasks = {mockData}/></BrowserRouter>);
...
test("Renders multiple subtasks correctly", () =>  {
    const mockData = [{id:0, name:"Subtask 1"}, {id:1, name:"Subtask 2"}, {id:2, name:"Subtask 3"}];
    const{container} = render(<BrowserRouter><Task expanded name = "Test 2" subtasks = {mockData}/></BrowserRouter>);
